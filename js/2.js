let colors = document.querySelectorAll('#colors>span')
        ...
        function cart(f) {
                ...
                _div1.innerHTML = `
                       <div id="choos" class="w-full flex justify-end">
                               <i onclick="closeopt(this)" class=" bi bi-x text-red-500 text-[25px] cursor-pointer"></i>
                       </div>
                        <div class="w-full flex">
                                        <figure class="w-[200px] mr-3">
                                                <img src="../img/60.jpg" alt="" class="flex h-[200px] object-cover rounded-[10px]">
                                        </figure>
                                        <div
